...
public class UGshackFeature extends Feature<NoneFeatureConfiguration> {
	public static UGshackFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new UGshackFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("simple_hearts:u_gshack", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("simple_hearts:u_gshack", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("simple_hearts", "ug_shack"));
		if (template == null)
			return false;
