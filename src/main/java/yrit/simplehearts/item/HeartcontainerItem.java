...
public class HeartcontainerItem extends SimpleHeartsModElements.ModElement {
	@ObjectHolder("simple_hearts:heartcontainer")
	public static final Item block = null;

	public HeartcontainerItem(SimpleHeartsModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(HearttabItemGroup.tab).maxStackSize(16).rarity(Rarity.RARE));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			HeartcontainerRightClickedProcedure.executeProcedure(Stream
