...
public class SimpleHeartsModVariables {
	public SimpleHeartsModVariables(SimpleHeartsModElements elements) {
	...
	public static class PlayerVariables {
		...
		public void syncPlayerVariables(Entity entity) {
			if (entity instanceof ServerPlayerEntity)
				SimpleHeartsMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) entity),
